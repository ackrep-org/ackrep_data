...
B1 = sp.MatrixSymbol('B1', 6, 3)
C1 = sp.MatrixSymbol('C1', 3, 6)
...
A_nv = sp.Matrix(np.array([[-1.,  0.,  4.,  5., -3., -2.],
       [-2.,  4., -7., -2.,  0.,  3.],
       [-6.,  9., -5.,  0.,  2., -1.],
       [-8.,  4.,  7., -1., -3.,  0.],
       [ 2.,  5.,  8., -9.,  1., -4.],
...
B1_nv = sp.Matrix(np.array([[ 1.,  0.],
       ...
       [ 0.,  5.],
       [-6., -2.]]))
C1_nv = sp.Matrix(np.array([[ 1., -1.,  2., -4.,  0., -3.],
       [-3.,  0.,  5., -1.,  1.,  1.],
       [-7.,  5.,  0., -8.,  2., -2.]]))
C_nv = sp.Matrix(np.array([[ 9., -3.,  4.,  0.,  3.,  7.],
       [ 0.,  1., -2.,  1., -6., -2.]]))
D11_nv = sp.Matrix(np.array([[ 1., -2., -3.],
       [ 0.,  4.,  0.],
       [ 5., -3., -4.]]))
