...
# set model name
model_name = 'Rank-deficient matrix D12,'
...
C1 = sp.MatrixSymbol('C1', 2, 3)
C = sp.MatrixSymbol('C', 1, 3)
...
B1_nv = sp.Matrix(np.array([[ 1.,  0.],
       [ 0.,  0.],
       [ 0., -1.]]))
C1_nv = sp.Matrix(np.array([[1., 0., 1.],
       [1., 0., 1.]]))
C_nv = sp.Matrix(np.array([[1., 0., 0.]]))
D11_nv = sp.Matrix(np.array([[0.],
       [0.]]))
D12_nv = sp.Matrix(np.array([[0., 1.],
       [0., 0.]]))
