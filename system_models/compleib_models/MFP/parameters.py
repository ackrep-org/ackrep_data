# This file was autogenerated from the template: parameters.py.template (2022-10-10 15:53:38).
...
# set model name
model_name = 'Moored Floating Platform'
...
A_nv = sp.Matrix(np.array([[ 0.     ,  0.     ,  1.     ,  0.     ],
       [ 0.     ,  0.     ,  0.     ,  1.     ],
