...
# set model name
model_name = 'Classical example'


# ---------- create symbolic parameters
A = sp.MatrixSymbol('A', 2, 2)
B = sp.MatrixSymbol('B', 2, 1)
B1 = sp.MatrixSymbol('B1', 2, 2)
C1 = sp.MatrixSymbol('C1', 2, 2)
C = sp.MatrixSymbol('C', 1, 2)
...
A_nv = sp.Matrix(np.array([[ 0.,  1.],
       [-1.,  0.]]))
B_nv = sp.Matrix(np.array([[0.],
       [1.]]))
B1_nv = sp.Matrix(np.array([[0.],
       [1.]]))
C1_nv = sp.Matrix(np.array([[1., 0.],
       [0., 0.]]))
C_nv = sp.Matrix(np.array([[0., 1.]]))
