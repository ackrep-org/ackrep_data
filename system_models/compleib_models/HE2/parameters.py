...
# set model name
model_name = 'AH-64 HELICOPTER at 130 knots Ph.'
...
A_nv = sp.Matrix(np.array([[-0.0649,  0.0787,  0.1705, -0.5616],
       [ 0.0386, -0.939 ,  4.2277,  0.0198],
       [ 0.1121, -0.4254, -0.7968,  0.    ],
       [ 0.    ,  0.    ,  1.    ,  0.    ]]))
B_nv = sp.Matrix(np.array([[ -0.9454,   0.5313],
       [ -8.6476, -10.769 ],
       [ 19.0824,  -2.8959],
       [  0.    ,   0.    ]]))
B1_nv = sp.Matrix(np.array([[ -0.9454,   0.5313],
       [ -8.6476, -10.769 ],
       [ 19.0824,  -2.8959],
       [  0.    ,   0.    ]]))
