...
- pk
    - (primary key; uppercase alphanumeric string of length-5)
- name
    - (string of length <= 40)
- short_description
...
- related_docs
    - (list of pks (referring to doc-entities))
- related_datasets
    - (list of pks (referring to dataset-entities))
- external_references
...
- `metadata.yml`
    ...
    - solved_problems
        - (list of pks)
    - used_methods
        - (list of pks; only these methods will be available to the software)
    - related_datasets
        - (list of pks; only these datasets will be available to the software)
    - compatible_environments
        - (list of pks)
- estimated_runtime
...
- `description.md`
- `dependencies.yml`
- `solution.ipynb` (optional)
- `postprocessing.ipynb` (optional)
- `_solution_data/`
    - my created by the solution code
